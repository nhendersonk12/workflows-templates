...
class ApiTest(unittest.TestCase):
    ...
    def test_01_empty(self):
        ...
        #request_json = {'query': [],'type': 'numpy', 'mode': 'test'}
        # Nothing at all
        ...
        # No query
        request_json = {'type': 'numpy', 'mode': 'test'}
        r = requests.post('http://localhost:8080/predict', json=request_json)
        response = json.loads(r.text)
    ...
    def test_03_log(self):
        r = requests.get('http://localhost:8080/logs/weird-filename.txt')
